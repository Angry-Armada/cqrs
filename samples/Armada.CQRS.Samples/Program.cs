...
using Armada.CQRS.Extensions.FluentValidation.Notifications.Extensions;
...
builder.Services.AddNotificationDispatcher()
    ...
    .AddGlobalNotificationMiddleware(typeof(GlobalNotificationLoggingMiddleware<>))
    .AddSpecificNotificationMiddleware<WeatherForecastCreatedNotificationLoggingMiddleware,
        WeatherForecastCreatedNotification>()
    .AddNotificationFluentValidation();
